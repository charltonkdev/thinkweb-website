...
export default function Hero() {
    ...
    return (
        <div className="flex flex-col h-full lg:h-screen items-center container relative py-24 overflow-hidden">
            ...
            {animationStep >= 4 && (
                <motion.div
                    ...
                    <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-[#020817] bg-[#020817] [mask-image:radial-gradient(ellipse_at_center,transparent_0%,black)]" />
                    <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-[#020817] bg-[#020817] [mask-image:radial-gradient(ellipse_at_center,transparent_0%,black)]" />
                    <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-[#020817] bg-[#020817] [mask-image:radial-gradient(ellipse_at_center,transparent_0%,black)]" />
                </motion.div>
            )}
